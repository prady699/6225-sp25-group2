...
export default function SearchPage() {
  ...
  const handleSelectPreference = (preferenceData: any) => {
    ...
    const standardAmenities = preferenceData.amenities?.filter(a => predefinedAmenityIds.includes(a)) || [];
    const customAmenities = preferenceData.amenities?.filter(a => !predefinedAmenityIds.includes(a)) || [];
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={() => updateFormData({ minPrice: 500, maxPrice: 1000 })}
                className={`p-4 rounded-xl border ${
                  formData.minPrice === 500 && formData.maxPrice === 1000
              ...
              <button
                onClick={() => updateFormData({ minPrice: 1000, maxPrice: 1500 })}
                className={`p-4 rounded-xl border ${
                  formData.minPrice === 1000 && formData.maxPrice === 1500
                    ? 'border-yellow-400 bg-yellow-50'
                    : 'border-gray-200 hover:border-yellow-400'
                }`}
              >
              ...
              <button
                onClick={() => updateFormData({ minPrice: 1500, maxPrice: 2000 })}
                className={`p-4 rounded-xl border ${
                  formData.minPrice === 1500 && formData.maxPrice === 2000
                    ? 'border-yellow-400 bg-yellow-50'
                    : 'border-gray-200 hover:border-yellow-400'
                }`}
              >
              ...
              <button
                onClick={() => updateFormData({ minPrice: 2000, maxPrice: 3000 })}
                className={`p-4 rounded-xl border ${
                  formData.minPrice === 2000 && formData.maxPrice === 3000
                    ? 'border-yellow-400 bg-yellow-50'
                    : 'border-gray-200 hover:border-yellow-400'
                }`}
              >
